  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-3 bg-card-content p-4">
        <h2 className="text-[20px] font-bold leading-[20px] text-foreground line-clamp-2 min-h-[40px]">
          {product.title}
        </h2>
        ...
        <Link
          ...
          className="mt-auto inline-flex h-11 items-center justify-center rounded-pill bg-cta px-5 text-[18px] font-bold uppercase text-cta-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cta focus-visible:ring-offset-2"
        >
          Eu quero
        </Link>
      </div>
